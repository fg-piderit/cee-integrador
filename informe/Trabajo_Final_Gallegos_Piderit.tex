...
\title{Trabajo práctico final \\[1em]%
  \large Especialización en estadística matemática \\%
...
\input{tex/exploratorio.tex}

\section{Estrategia de modelado}\label{sec:estmod}

\input{tex/estrategia.tex}
...
\begin{table}[h]
\input{cuadros/descriptivos.tex}
  \caption{Estadísticos descriptivos de las variables según sufijo (\textit{\_mean, \_se, \_worst}) y característica de las células}
\label{tab:resumen}
\end{table}
